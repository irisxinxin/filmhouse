...
func Seed(db *gorm.DB) error {
	...
	films := []models.Film{
		...
		},
		{
			...
			Language:   "Farsi",
			Subtitles:  "English",
			PosterURL:  "/images/films/it-was-just-an-accident.png",
		...
		},
		{
			...
			Subtitles:  "English",
			PosterURL:  "/images/films/10s-across-the-borders.png",
			IsFeatured: false,
			IsActive:   true,
		},
		{
			...
			Subtitles:  "English",
			PosterURL:  "/images/films/sentimental-value.png",
		...
		},
		{
			...
			PosterURL:  "/images/films/rental-family.png",
